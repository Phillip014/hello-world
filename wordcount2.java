...
public class wordcount {
	...
	public static void main(String[] args) throws Exception {
		...
		FileInputFormat.addInputPath(job, new Path("hdfs://master-m730026014:9000/data/ass4/test"));
		FileOutputFormat.setOutputPath(job, new Path("hdfs://master-m730026014:9000/data/MR-2"));
